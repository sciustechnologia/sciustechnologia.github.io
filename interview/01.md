...
* mobile application testing (including iOS).
* Software QA methodologies & practices.
* debugging, troubleshooting , applying analytical thinking skills to systematically assess project quality.
* Client/Server Architecture and mobile E-Commerce domain.
* test automation frameworks and scripting languages.
